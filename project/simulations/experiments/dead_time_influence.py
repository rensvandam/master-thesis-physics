...
#25-3-2025
#What to do:
# Investigate impact of deadtime on emitter estimation.
# How?
# Gather estimation results for different deadtimes.
# Make a plot with on y-axis the number of estimated emitters and on the x axis the deatime.
...
deadtimes = np.linspace(0.1, 100, 9) # ns
estimated_emitters = []
standard_deviations = []
for deadtime in deadtimes:
    ...
    for seed in range(100):
        n, _ = sim_whole_detector(deadtime, nr_emitters=3, laser=330 * 10**3, 
...
plt.errorbar(deadtimes, estimated_emitters, yerr=standard_deviations, fmt='o', capsize=5)
